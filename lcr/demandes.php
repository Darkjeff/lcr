...
/**
 *  \file       htdocs/compta/lcr/demandes.php
 *  \ingroup    lcr
...
if ($resql)
{
	...
	if (!$statut)
	{
		print_barre_liste($langs->trans("BankdraftRequestStandingOrderToTreat"), $page, "demandes.php", $urladd, $sortfield, $sortorder, '', $num);
	}
	else
	{
		print_barre_liste($langs->trans("BankdraftRequestStandingOrderTreated"), $page, "demandes.php", $urladd, $sortfield, $sortorder, '', $num);
	}
