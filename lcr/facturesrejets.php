 ...
 *
 * $Id: facturesrejets.php,v 1.5 2009/02/20 22:53:47 eldy Exp $
 * $Source: /cvsroot/dolibarr/dolibarr/htdocs/compta/lcr/facturesrejets.php,v $
 *
 */
...
require_once DOL_DOCUMENT_ROOT."/compta/lcr/rejet-lcr.class.php";
...
llxHeader('',$langs->trans("BankdraftReceipt"));

$h = 0;
$head[$h][0] = DOL_URL_ROOT.'/compta/lcr/fiche.php?id='.$_GET["id"];
$head[$h][1] = $langs->trans("Fiche");
$h++;      

$head[$h][0] = DOL_URL_ROOT.'/compta/lcr/factures.php?id='.$_GET["id"];
$head[$h][1] = $langs->trans("Factures");
$h++;  

$head[$h][0] = DOL_URL_ROOT.'/compta/lcr/rejets.php?id='.$_GET["id"];
$head[$h][1] = $langs->trans("Rejets");
$hselected = $h;
$h++;  


$head[$h][0] = DOL_URL_ROOT.'/compta/lcr/fiche-stat.php?id='.$_GET["id"];
...
$sql .= " FROM ".MAIN_DB_PREFIX."lcr as p";
$sql .= " , ".MAIN_DB_PREFIX."lcr_facture as pf";
$sql .= " , ".MAIN_DB_PREFIX."facture as f";
$sql .= " , ".MAIN_DB_PREFIX."societe as s";
$sql .= " WHERE pf.fk_lcr = p.rowid";
  ...
  while ($i < min($num,$conf->liste_limit))
    {
      ...
      print "<tr $bc[$var]><td>";
      print '<a href="'.DOL_URL_ROOT.'/compta/lcr/fiche.php?id='.$obj->rowid.'">'.$obj->ref."</a></td>\n";
      print "<td>";
      print '<a href="'.DOL_URL_ROOT.'/compta/facture/card.php?facid='.$obj->facid.'">';
      print img_picto("", "file");//img_file();      
      print '</a>&nbsp;';
...
llxFooter('$Date: 2009/02/20 22:53:47 $ - $Revision: 1.5 $');
?>
